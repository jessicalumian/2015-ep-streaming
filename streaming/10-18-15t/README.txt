Goal: Run 1 and 2 of protocols using semi-streaming khmer branch. Commands
are same as before, but during khmer install use --branch cleanup/semistreaming
instead of --branch v2.0 during khmer-protocols.git execution, and got rid
of normalize-by-median.py command at end of streaming script and replaced
with diginorm parameter in trim-low-abund.py

Code: (partially copied from 10-10-15 README.txt)
