...
al: Run same process/code as 10-10-15, but measure size of output files. 
In future runs, trim-low-abund.py params will be modified, so I want to 
be able to compare file sizes from here on out.

file size screen shot in out-file-size.png, files found in
/mnt/work/paired.gz and /mnt/work/single.gz after these commands
...
Code: (copied from 10-14-15 README.txt)
