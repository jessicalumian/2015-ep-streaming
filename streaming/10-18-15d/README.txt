...
instead of --branch v2.0 during khmer-protocols.git execution

Note: I forgot to change the streaming script at the end of 1-rst
so this produces identical output to 10-18-15, so this run info 
isn't very informative. oops!
